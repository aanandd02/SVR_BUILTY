...
function collectFormData() {
  const data = {
    ...
    serviceTaxLiable:
      document.querySelector('input[name="serviceTaxLiable"]:checked')?.value ||
      "",
    lorryNo: document.getElementById("lorryNo").value,
    insuranceStatus:
      document.querySelector('input[name="insuranceStatus"]:checked')?.value ||
      "not_insured",
    ...
    transportMode:
      document.querySelector('input[name="transportMode"]:checked')?.value ||
      "road",
...
function resetForm() {
  if (confirm("Are you sure you want to reset the form?")) {
    ...
    document.querySelector(
      'input[name="insuranceStatus"][value="not_insured"]',
    ).checked = true;
    document.querySelector(
      'input[name="transportMode"][value="road"]',
    ).checked = true;
